...
const Footer = () => {
  return (
    <div className="footerContainer">
      <div className="footerBlock blockone">
        Get connected with us on social networks!
      </div>
      <div className="footerBlock blocktwo">
        © 2023 — <strong>UCSD Triple C</strong>{" "}
      </div>
      <div className="footerBlock blockthree">
        <a href="http://weixin.qq.com/r/OB26olfEnArjrRPB90gq">
          <svg
