    ...
    return(
        <div className="fpLayout">
            <div className="titleSection">
                <h1 className="projTitle">{featuredJson.featuredProjects.title}</h1>
                <h2 className="projSubtitle">{featuredJson.featuredProjects.subtitle}</h2>
            </div>
            ...
            <div className="Project">
                <div className="Project1">
                    ...
                    <div className="Pro1Descript txt">
